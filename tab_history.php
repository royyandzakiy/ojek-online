<div class="header">
  ...
  <?php
    ...
    $id = $_SESSION['id_pengguna'];
	  ...
	  // tahap 1
	    $query_driver="SELECT pengguna.profpic, pemesanan.tanggal, pengguna.nama, pemesanan.pick_point, pemesanan.dest_point, pemesanan.rating, pemesanan.comment FROM pemesanan JOIN pengguna ON (pengguna.id = pemesanan.id_pengguna) WHERE pemesanan.id_pengguna = '$id'";
